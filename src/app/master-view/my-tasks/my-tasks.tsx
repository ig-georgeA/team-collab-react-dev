  ...
  return (
    <>
      <div className={classes("row-layout my-tasks-container")}>
            ...
            <div className={classes("row-layout group_3")}>
              <div className={classes("column-layout group_4")}>
                <div className={classes("column-layout group_5")}>
                  ...
                  <IgrButton variant="flat" size="large" clicked={() => newTaskDialog1?.current?.toggle()} className={classes("button")}>
                    <span className={classes("material-icons")} key={uuid()}>
                      <span key={uuid()}>add</span>
                    </span>
                ...
                <div className={classes("column-layout group_5")}>
                  ...
                  <IgrList className={classes("list_1")}>
                    <IgrListItem key={uuid()}>
                      <div style={{display: 'contents'}} slot="start" key={uuid()}>
                        <IgrAvatar src="/src/assets/Avatar3.png" shape="circle" className={classes("avatar")}></IgrAvatar>
                      </div>
                    ...
                    <IgrListItem key={uuid()}>
                      <div style={{display: 'contents'}} slot="start" key={uuid()}>
                        <IgrAvatar src="/src/assets/Avatar5.png" shape="circle" className={classes("avatar")}></IgrAvatar>
                      </div>
        ...
        <IgrDialog closeOnOutsideClick="true" ref={editTaskDialog}>
          ...
          <div className={classes("column-layout group_9")} key={uuid()}>
            ...
            <div className={classes("row-layout group_10")}>
              ...
              <IgrChip size="large" className={classes("content_1")}>
            ...
            <div className={classes("row-layout group_14")}>
              <IgrButton variant="flat" size="large" clicked={() => editTaskDialog?.current?.toggle()} className={classes("button_1")}>
                <span key={uuid()}>CANCEL</span>
                <IgrRipple key={uuid()}></IgrRipple>
              </IgrButton>
              <IgrButton size="large" clicked={() => editTaskDialog?.current?.toggle()} className={classes("button_1")}>
        ...
        <IgrDialog closeOnOutsideClick="true" ref={newTaskDialog1}>
          ...
          <div className={classes("row-layout group_7")} key={uuid()}>
            <div className={classes("column-layout group_15")}>
              ...
              <div className={classes("row-layout group_14")}>
                <IgrButton variant="flat" size="large" clicked={() => newTaskDialog1?.current?.toggle()} className={classes("button_1")}>
                  <span key={uuid()}>CANCEL</span>
                  <IgrRipple key={uuid()}></IgrRipple>
                </IgrButton>
                <IgrButton size="large" clicked={() => newTaskDialog1?.current?.toggle()} className={classes("button_1")}>
        ...
        <IgrButton variant="fab" size="large" clicked={() => newTaskDialog1?.current?.toggle()} className={classes("button_2")}>
          <span className={classes("material-icons")} key={uuid()}>
            <span key={uuid()}>add</span>
          </span>
          <IgrRipple key={uuid()}></IgrRipple>
