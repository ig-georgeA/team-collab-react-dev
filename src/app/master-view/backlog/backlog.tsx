          ...
          <IgrList className={classes("list")}>
            ...
            <IgrListItem key={uuid()}>
              <div style={{display: 'contents'}} slot="start" key={uuid()}>
                <IgrAvatar className={classes("avatar")}>
            ...
            <IgrListItem key={uuid()}>
              <div style={{display: 'contents'}} slot="start" key={uuid()}>
                <IgrAvatar className={classes("avatar_1")}>
                  <span className={classes("material-icons icon")} key={uuid()}>
                    <span key={uuid()}>dashboard</span>
                  </span>
                </IgrAvatar>
            ...
            <IgrListItem key={uuid()}>
              <div style={{display: 'contents'}} slot="start" key={uuid()}>
                <IgrAvatar className={classes("avatar_2")}>
                  <span className={classes("material-icons icon")} key={uuid()}>
                    <span key={uuid()}>dashboard</span>
                  </span>
                </IgrAvatar>
          ...
          <div className={classes("column-layout content")}>
            ...
            <IgrTabs className={classes("tabs")}>
              ...
              <IgrTabPanel className={classes("column-layout tab-item-content")} key={uuid()}>
                <IgrGrid data={northwindOrders} primaryKey="employeeID" displayDensity="cosy" allowFiltering="true" filterMode="excelStyleFilter" className={classes("ig-typography ig-scrollbar grid")}>
              ...
              <IgrTabPanel className={classes("row-layout tab-item-content")} key={uuid()}>
                <IgrGrid data={northwindCustomers} primaryKey="customerID" displayDensity="cosy" allowFiltering="true" filterMode="excelStyleFilter" className={classes("ig-typography ig-scrollbar grid_1")}>
                  <IgrColumn field="customerID" dataType="string" header="customerID" sortable="true" selectable="false"></IgrColumn>
              ...
              <IgrTabPanel className={classes("row-layout tab-item-content")} key={uuid()}>
                <IgrGrid data={northwindEmployees} primaryKey="employeeID" displayDensity="cosy" allowFiltering="true" filterMode="excelStyleFilter" className={classes("ig-typography ig-scrollbar grid_1")}>
              ...
              <IgrTabPanel className={classes("row-layout tab-item-content")} key={uuid()}>
                <IgrGrid data={northwindSuppliers} primaryKey="supplierID" displayDensity="cosy" allowFiltering="true" filterMode="excelStyleFilter" className={classes("ig-typography ig-scrollbar grid_1")}>
