      ...
      <div className={classes("row-layout sign-in-container")}>
        <div className={classes("row-layout left")}>
          <div className={classes("column-layout group")}>
            ...
            <IgrButton size="large" clicked={() => navigate(`/master-view/my-tasks`)} className={classes("button_1")}>
            ...
            <IgrButton variant="outlined" size="large" clicked={() => navigate(`/login/create-account`)} className={classes("button_1")}>
